...
//        bookInfoDTOS.add(new BookInfoDTO(3, "금도끼 은도끼", "도끼를 잃어버린 성실한 청년이 금도끼, 은도끼, 동도끼 모두를 가지고 선녀와 행복하게 사는 이야기", "전래동화", "한국", 10, "2342", 1));
        bookInfoDTOS.add(new BookInfoDTO(1, "금도끼 은도끼", "성실한 나무꾼은 과연 어떻게 금도끼를 갖게 되었을까요?", "교훈", "한국", 18, "https://storage.googleapis.com/ft-island-image/goldsilver0.webp", 1));
        bookInfoDTOS.add(new BookInfoDTO(2, "그림자 괴물", "그림자 괴물이 생겨난 이유가 궁금하지 않아?", "모험", "한국", 5, "https://storage.googleapis.com/ft-island-image/shadow0.webp", 1));
